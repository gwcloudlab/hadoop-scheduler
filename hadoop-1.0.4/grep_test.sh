...
./bin/hadoop jar grep.jar org.apache.hadoop.examples.Grep -D mapred.job.relative.deadline=$1 /zhangwei1984/wordcount/input/dir_1G /zhangwei1984/grep/output/1G-output 'dfs[a-z.]+' $2
