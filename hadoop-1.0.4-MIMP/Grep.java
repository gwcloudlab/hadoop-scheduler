...
public class Grep extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    if (args.length < 3) {
      System.out.println("Grep <inDir> <outDir> <regex> [<sortrelativeDeadline>] [<group>]");
    ...
    try {
      ...
      if (args.length == 4) {
	int relativeDeadline = Integer.parseInt(args[3]);
      	sortJob.setInt("mapred.job.relative.deadline", relativeDeadline);
      }
